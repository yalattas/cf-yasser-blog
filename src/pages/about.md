...
I build the infrastructure that keeps large-scale systems running: multi-cluster Kubernetes platforms, GitOps pipelines, AI inference at production scale, and everything in between.
